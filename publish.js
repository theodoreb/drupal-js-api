(function () {
  ...
  var template = require(env.dirname + '/node_modules/jsdoc/template'),
    fs = require(env.dirname + '/node_modules/jsdoc/fs'),
    path = require(env.dirname + '/node_modules/jsdoc/path'),
    taffy = require('taffydb').taffy,
    handle = require(env.dirname + '/node_modules/jsdoc/util/error').handle,
    helper = require(env.dirname + '/node_modules/jsdoc/util/templateHelper'),
  ...
  function generateSourceFiles (sourceFiles, encoding) {
    ...
    Object.keys(sourceFiles).forEach(function (file) {
      ...
      generate('Source: ' + sourceFiles[file].shortened, [
        source
      ], sourceOutfile,
        false);
    });
